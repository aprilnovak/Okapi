...
\begin{figure}[H]
\centering
\includegraphics[width=17.5cm]{OpenMC-BISON-Nek-complicated.png}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=17.5cm]{OpenMC-BISON-Nek-step1.png}
\end{figure}

The example in {\tt tests/transfers/okapi-bison-nek} shows a functioning three-way coupling for a single fuel pin.
...
! Set the orders of the expansion that will be used. This should match the orders used in the MOOSE input files.
      n_legendre=10
      m_fourier=5
c-----------------------------------------------
